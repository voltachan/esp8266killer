...
function draw(){
	getE("deauth").innerHTML = attackJSON[0][0] ? lang("停止") : lang("开始");
	getE("beacon").innerHTML = attackJSON[1][0] ? lang("停止") : lang("开始");
	getE("probe").innerHTML = attackJSON[2][0] ? lang("停止") : lang("开始");
